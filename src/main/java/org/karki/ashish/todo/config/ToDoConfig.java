package org.karki.ashish.todo.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "org.karki.ashish.todo.repository")
...
public class ToDoConfig implements WebMvcConfigurer {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        converters.add(new MappingJackson2XmlHttpMessageConverter(
                jackson2ObjectMapperBuilder.createXmlMapper(true).build()));
    }
